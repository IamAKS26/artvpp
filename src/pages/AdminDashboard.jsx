...
import { DollarSign, Users, ShoppingCart, AlertCircle, BarChart2, Shield, Menu, X } from "lucide-react";
import { motion, AnimatePresence } from 'framer-motion';
import Button from '../components/ui/Button'; // Assuming Button is available or I should use standard button
            ...
            <main className="pt-24 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="md:hidden mb-6">
                        ...
                        >
                            <Menu size={20} />
                            {isSidebarOpen ? 'Close Menu' : 'Show Admin Menu'}
                        </button>
                    </div>
                                ...
                                >
                                    ...
                                    <nav className="space-y-2">
                                        ...
                                        <button
                                            ...
                                            className={`w-full text-left px-4 py-3 rounded-xl flex items-center gap-3 transition-colors ${activeTab === 'users' ? 'bg-gray-100 dark:bg-white/10 font-medium' : 'text-gray-500 hover:bg-gray-50 dark:hover:bg-white/5'}`}
                                        >
                                            <Users size={20} /> Users
                                        </button>
                                        <button
                                            onClick={() => { setActiveTab('approvals'); setIsSidebarOpen(false); }}
                                            className={`w-full text-left px-4 py-3 rounded-xl flex items-center gap-3 transition-colors ${activeTab === 'approvals' ? 'bg-gray-100 dark:bg-white/10 font-medium' : 'text-gray-500 hover:bg-gray-50 dark:hover:bg-white/5'}`}
                                        >
                                            <AlertCircle size={20} /> Approvals
                                        </button>
                                    </nav>
